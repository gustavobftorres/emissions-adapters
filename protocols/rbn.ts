...
const ecosystemRemaining = ecosystem.total - ecosystem.monthlyAmounts.reduce((acc, v) => acc + v, 0)
...
const reserveSection : SectionV2 = {
    displayName: "Reserve (TBD)",
    isTBD: true,
    components: [
        {
            id: "reserve-tbd",
            name: "Reserve (TBD)",
            isTBD: true,
            methodology: "20% of the total supply is allocated to the reserve with no defined unlock schedule",
            fetch: async () => [manualCliff(tge, reserve.total)]
        }
    ]
}
const remainingEcosystem : SectionV2 = {
    displayName: "Ecosystem (TBD)",
    isTBD: true,
    components: [
        {
            id: "ecosystem-tbd",
            name: "Ecosystem (TBD)",
            isTBD: true,
            methodology: "The remaining portion of the ecosystem allocation that doesn't have a defined unlock schedule",
            fetch: async () => [manualCliff(tge, ecosystemRemaining)]
        }
    ]
}
...
const rbn: Protocol = {
  ...
  "Ecosystem & Community (TBD)": remainingEcosystem,
  "Reserve (TBD)": reserveSection,
  meta: {
    version: 2,
  ...
  categories: {
    noncirculating: ["Governance DAO", "Reserve (TBD)", "Ecosystem & Community (TBD)"],
